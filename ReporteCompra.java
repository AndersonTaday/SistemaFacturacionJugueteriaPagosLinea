...
public class ReporteCompra extends javax.swing.JFrame {
    ...
    private void mostrarDatos() {
        ...
        try {
            ...
            if (cbxTipoBusqueda.getSelectedIndex() == 0) {
                rsAux = stAux.executeQuery("SELECT idProveedor FROM proveedor WHERE nombre = " + tfTipoBusqueda.getText());
                rsAux.next();
                rs = st.executeQuery("SELECT idDetCompra,detacjug_idJuguete,descripcion,precioUnitario,precioTotal FROM detallecompra WHERE provedor_idProvedor = " + rs.getInt(1));
                ...
                rsAux.next();
                rs = st.executeQuery("SELECT idDetCompra,detacjug_idJuguete,descripcion,precioUnitario,precioTotal FROM detallecompra WHERE detacjug_idJuguete = " + rs.getInt(1));
            } else if (cbxTipoBusqueda.getSelectedIndex() == 2) {
                rsAux = stAux.executeQuery("SELECT idCompra FROM compra WHERE numCompra = " + tfTipoBusqueda.getText());
                rsAux.next();
                rs = st.executeQuery("SELECT idDetCompra,detacjug_idJuguete,descripcion,precioUnitario,precioTotal FROM detallecompra WHERE compras_idCompra = " + rs.getInt(1));
            }
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        cbxTipoBusqueda.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Proveedor", "Código Juguete", "Nro Compra" }));
